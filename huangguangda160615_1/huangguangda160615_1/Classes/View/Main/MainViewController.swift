...
class MainViewController: UITabBarController {
    ...
    public lazy var
    composedButton:UIButton=UIButton(imageName:"tabbar_compose_icon_add",backImageName:"tabbar_compose_button")
...
extension MainViewController
{
    public func addChildViewControllers() {
        ...
        addChildViewController(vc: MessgeTableViewController(), title: "消息", imageName: "tabbar_message_center")
